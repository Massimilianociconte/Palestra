...
export class NotificationManager {
    ...
    startSilentLoop() {
        this.unlockAudio();
        // We don't need a constant loop if we rely on the "wake lock" style or just resumed context.
        // But some iOS versions aggressively kill the context if no sound plays.
        // A very low volume constant sound is better.
        // However, an infinite loop oscillator consumes battery.
        // Let's try just ensuring context is resumed. 
        // If we really need it, we can play a phantom sound.
    }
